...
class EventCfg:
    ...
    end_effector_material = EventTerm(
        ...
        params={
            ...
            "restitution_range": (0.6, 0.9),          # End effector restitution (lower for grip)
            "num_buckets": 250,
        },
    )
    ...
    tennis_ball_material = EventTerm(
        ...
        params={
            ...
            "restitution_range": (0.6, 0.9),          # Tennis ball restitution (higher for bounce)
            "num_buckets": 250,
        },
    )
    ...
    tennisball = RigidObjectCfg(
        ...
        spawn=sim_utils.SphereCfg(
            ...
            rigid_props=sim_utils.RigidBodyPropertiesCfg(
                ...
                sleep_threshold=0.001,  # Reduced - keeps ball active longer
                stabilization_threshold=0.001,  # Reduced - less energy dissipation
                max_depenetration_velocity=10000.0,  # Increased for faster separation
            ),
            mass_props=sim_utils.MassPropertiesCfg(mass=0.052),
            collision_props=sim_utils.CollisionPropertiesCfg(
                collision_enabled=True,
                contact_offset=0.002,  # Slightly increased for better contact detection
                rest_offset=0.0,
            ...
            physics_material=RigidBodyMaterialCfg(
                ...
                improve_patch_friction=False,  # Disabled - can reduce bouncing
...
class Lbr_iiwaSixStatesEnv(DirectRLEnv):
    ...
    def _get_observations(self) -> dict:
        ...
        obs_actor = torch.cat(
            (   self.action_history_actor.flatten(start_dim=1), #35
                ...
                (self.tennisball_lin_vel + torch.randn_like(self.tennisball_lin_vel) * 0.005) * self.cfg.lin_vel_scale,
    ...
    def _compute_intermediate_values(self, env_ids: torch.Tensor | None = None):
        ...
        if can_revert_to_catching_ball.any():
            ...
            self.revert_penalty[can_revert_to_catching_ball] = - 4.0 * torch.norm(self.end_effector_lin_vel[can_revert_to_catching_ball] - self.tennisball_lin_vel[can_revert_to_catching_ball], p=2, dim=-1)
    ...
    def _compute_rewards(
        ...
        r_v_weight = torch.exp(-0.25 * r_v**2)
        ...
        rewards = (
            ...
            - action_sign_change_penalty * 0.02     #w
            # + alive_reward
            + self.revert_penalty       #w
            + finished_reward #w
            + joint_vel_penalty * 5.0 #w
        )
