...
class Lbr_iiwaSixStatesEnvCfg(DirectRLEnvCfg):
    ...
    joint_accel_scale = 2.0e-7
    joint_jerk_scale = 4.0e-11
    joint_torque_scale = 2.0e-7
...
class Lbr_iiwaSixStatesEnv(DirectRLEnv):
    ...
    def _compute_rewards(
        ...
        if throwing_ball_mask.any():
            ...
            to_throwing_vel_normalized_reward[throwing_ball_mask] = (self.throwing_vel_norm[throwing_ball_mask] * normalized_end_effector_z[throwing_ball_mask]).sum(dim=-1)
            ...
            orient_reward[throwing_ball_mask] = 2.0 * (self.throwing_vel_norm[throwing_ball_mask] * normalized_end_effector_z[throwing_ball_mask]).sum(dim=-1) + 1.0
