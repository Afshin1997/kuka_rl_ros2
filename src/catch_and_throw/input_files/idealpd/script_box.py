...
class EventCfg:
    ...
    end_effector_material = EventTerm(
        ...
        params={
            ...
            "static_friction_range": (0.3, 0.5),      # End effector friction range
            "dynamic_friction_range": (0.25, 0.45),     # End effector friction range  
            "restitution_range": (0.6, 0.85),          # End effector restitution (lower for grip)
            "num_buckets": 250,
        },
    )
    ...
    tennis_ball_material = EventTerm(
        ...
        params={
            ...
            "static_friction_range": (0.3, 0.5),      # Tennis ball friction range
            "dynamic_friction_range": (0.25, 0.45),     # Tennis ball friction range
            "restitution_range": (0.6, 0.85),          # Tennis ball restitution (higher for bounce)
            "num_buckets": 250,
        },
    )
...
class Lbr_iiwaSixStatesEnvCfg(DirectRLEnvCfg):
    ...
    robot = ArticulationCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path=f"/home/prisma-lab-ws/Scrivania/Omniverse/IsaacLab/source/IsaacSimPrismaLab/Lbr_iiwa/assets/lbr_iiwa7_3/lbr_description/urdf/iiwa7/lbr_iiwa7_323.usd",
...
class Lbr_iiwaSixStatesEnv(DirectRLEnv):
    ...
    def _compute_intermediate_values(self, env_ids: torch.Tensor | None = None):
        ...
        self.bouncing_velocity_threshold = 4.0 - 3.25 * curriculum_progress  # 5.0 -> 2.0
    ...
    def _compute_rewards(
        ...
        orient_reward = 0.6 * orientation_pure
