...
class EventCfg:
    ...
    reset_gravity = EventTerm(
        ...
        mode="reset",
        params={
            "gravity_distribution_params": ([-0.35, -0.15, -0.3], [0.35, 0.15, 0.3]),
            "operation": "add",
            "distribution": "uniform",
        },
    )
    ...
    end_effector_material = EventTerm(
        ...
        params={
            ...
            "restitution_range": (0.55, 0.7),          # End effector restitution (lower for grip)
            "num_buckets": 250,
        },
    )
    ...
    tennis_ball_material = EventTerm(
        ...
        params={
            ...
            "restitution_range": (0.55, 0.7),          # Tennis ball restitution (higher for bounce)
            "num_buckets": 250,
        },
    )
...
class Lbr_iiwaSixStatesEnv(DirectRLEnv):
    ...
    def _compute_intermediate_values(self, env_ids: torch.Tensor | None = None):
        ...
        if can_revert_to_catching_ball.any():
            ...
            self.revert_penalty[can_revert_to_catching_ball] = -2.0 * velocity_factor[can_revert_to_catching_ball]
            ...
            if high_bouncing.any():
                ...
                self.revert_penalty[high_bouncing] = -2.0 * velocity_factor[high_bouncing] - penalty_scale * (1 * velocity_factor[high_bouncing])
    ...
    def _compute_rewards(
        ...
        r_v_reward = 0.5 * distance_weight * (r_v_weight)
        ...
        acc_pen  = 0.5 * distance_weight * r_a_weight
