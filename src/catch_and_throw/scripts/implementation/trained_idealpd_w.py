...
class Actor(nn.Module):
    ...
    def __init__(
        ...
        layers.append(activation_fn)
        layers.append(nn.Linear(hidden_dims[3], num_actions))
...
class JointStateNode:
    ...
    def load_actor_and_normalization(self):
        ...
        model_path = rospy.get_param('~model_path', default='/home/user/ros_ws/src/catch_and_throw/input_files/idealpd/model_idealpd.pt')
