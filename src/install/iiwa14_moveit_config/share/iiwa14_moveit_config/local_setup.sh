...
: ${AMENT_CURRENT_PREFIX:="/home/user/kuka_rl_ros2/src/install/iiwa14_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/iiwa14_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/iiwa14_moveit_config/environment/path.sh"
