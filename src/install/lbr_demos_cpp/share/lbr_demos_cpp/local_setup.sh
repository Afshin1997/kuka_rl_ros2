...
: ${AMENT_CURRENT_PREFIX:="/home/user/kuka_rl_ros2/src/install/lbr_demos_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lbr_demos_cpp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lbr_demos_cpp/environment/path.sh"
